        ...
        FirebaseDatabase.getInstance().getReference().addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                if(data.getValue() != null) {
                    ...
                    am.setText("불고기 버거 주문 개수 " + data4.getValue().toString());
                    lt.setText("치즈 버거 주문 개수 " + data5.getValue().toString());
                    cp.setText("새우 주문 개수 " + data6.getValue().toString());
                    cm.setText("콜라 주문 개수 " + data7.getValue().toString());
                }
